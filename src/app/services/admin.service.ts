...
export class AdminService {
  ...
  obtener_mesajes_admin(token: any): Observable<any> {
    let headers = new HttpHeaders({
      'Content-Type': 'application/json',
      Authorization: token,
    });
    return this._http.get(this.url + 'obtener_mesajes_admin', {
      headers: headers,
    });
  }
  ...
  obtener_ventas_admin(desde:any,hasta:any,token: any): Observable<any> {
    ...
    return this._http.get(this.url + 'obtener_ventas_admin/'+desde+'/'+hasta, {
      headers: headers,
    });
  }
